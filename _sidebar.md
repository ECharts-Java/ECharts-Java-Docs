...
- Chart APIs & Demo
  - [Cartesian Coord Chart](chart-apis/cartesian-coord-chart)
    ...
    - [Bar](chart-apis/bar)
    - [PictorialBar](chart-apis/pictorial-bar)
    - [Scatter](chart-apis/scatter)
    - [EffectScatter](chart-apis/effect-scatter)
    - [Lines](chart-apis/lines)
    - [Boxplot](chart-apis/boxplot)
    - [Candlestick](chart-apis/candlestick)
    - [Heatmap](chart-apis/heatmap)
  - [Geo Coord Chart](chart-apis/geo-coord-chart)
    - [Map](chart-apis/map)
...
- Series APIs
  - [SeriesOption](series-apis/series-option)
    ...
    - [PictorialBarSeries](series-apis/pictorial-bar-series)
    - [ScatterSeries](series-apis/scatter-series)
    - [EffectScatterSeries](series-apis/effect-scatter-series)
    - [LinesSeries](series-apis/lines-series)
    ...
    - [MapSeries](series-apis/map-series)
